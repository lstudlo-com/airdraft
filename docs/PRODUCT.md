...
- Section heading rows have a shared 32 pt minimum height, with titles and
  trailing controls vertically centered. Use shared spacing: 12 pt from a section
