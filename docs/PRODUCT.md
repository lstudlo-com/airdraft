...
| 4 | Done: `RefinementProfile` + `ProfileStore`; Profiles pairs a compact list with an open editor. Instructions lead, optional Task expands when configured, and icon selection and prompt preview live in menus. |
