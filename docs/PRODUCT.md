...
- The sidebar uses native blur beneath a 92%-opaque neutral layer, leaving only
  slight translucency. Reduce Transparency makes the background fully opaque.
